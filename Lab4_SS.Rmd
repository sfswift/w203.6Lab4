...
Now let us check the remaining assumptions. First, we will examine the zero conditional mean assumption by looking at the plot of residuals vs fitted values.
=======
Now let us check the assumptions of the CLM. 


Let us examine the zero conditional mean assumption by looking at the plot of residuals vs fitted values.
>>>>>>> f79207e58203e9253767144cfa3cff89e03bbdbd
...
The red spline line is close to zero for all the fitted values, with only a small downturn on the left side. This supports making the MLR4 assumption.
