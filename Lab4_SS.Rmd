...
hist(log(crime$taxpc), breaks = 50,
     main="Histogram of log(taxpc)")
...
(c <- with(crime, cor(cbind(crmrte, density, log_density, med_wag, taxpc, log_taxpc, pctmin80, pctymle,log_pctymle, prbarr))))
```
